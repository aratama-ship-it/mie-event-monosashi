...
export function datePresets(todayIso) {
  ...
  return [
    ...
    // Without this, anything past the 30-day calendar and the next-month preset is
    // unreachable by browsing — you have to already know a date and type it in.
    {
      id: "later",
      label: "それ以降",
      from: addDays(endOfNextMonth, 1),
      to: `${year + 2}-12-31`,
    },
  ];
}
